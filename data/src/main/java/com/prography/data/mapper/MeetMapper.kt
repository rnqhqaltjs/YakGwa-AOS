        ...
        return responseMeetsDto.entryInfo.map { entryInfo ->
            MeetsResponseEntity(
                MeetsResponseEntity.MeetInfo(
                    entryInfo.meetInfo.address,
                    entryInfo.meetInfo.meetId,
                    entryInfo.meetInfo.placeName,
                    entryInfo.meetInfo.startMeetTime
                ),
                entryInfo.meetStatus,
                entryInfo.participantsInfo.map { participantInfo ->
                    MeetsResponseEntity.ParticipantsInfo(
